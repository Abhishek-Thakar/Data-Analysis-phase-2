...
# --- STEP 1: LOAD DATA ---
print("Loading data...")
# lineterminator handles potential newlines inside reviews
df = pd.read_csv('instagram.csv', lineterminator='\n')
...
# max_df=0.95 (ignore common), min_df=2 (ignore rare), max_features=1000 (limit size)
...
plot_top_words(nmf_model, feature_names, 10, 'Top Words per Topic (NMF)')
print("\nDone!")